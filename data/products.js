...
export class Appliances extends Products {
  ...
  constructor(productDetails) {
    super(productDetails);
    this.instrunctionLink = productDetails.instrunctionLink;
    this.warrantyLink = productDetails.warrantyLink;
  }

  extraInfoHtml() {
    return `
    <a href="${this.instrunctionLink}" traget="_blank">
      Instrunction
    </a>
...
export const products = [
  ...
  },
  {
    ...
    type: 'appliance',
    instrunctionLink: 'images/appliance-instructions.png',
  ...
  //   name: "Dora the Explora Backpack",
  //   rating: {
  //     stars: 4.5,
  //     count: 777
  //   },
