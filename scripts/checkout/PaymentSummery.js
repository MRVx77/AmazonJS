...
export function renderPaymentSummery() {
  ...
  cart.forEach((cartItem) => {
    ...
    shipphingPriceCents += deliveryOption.priceCents;
  });

  const totalBeforTaxCents = productPriceCents + shipphingPriceCents;
  ...
  const paymentSummaryHTML = `
       <div class="payment-summary-title">
        ...
        <div class="payment-summary-row">
          ...
          $${formatCurrency(shipphingPriceCents)}
          </div>
        </div>
  ...
  .addEventListener('click', async ()=>{
    ...
    try {
      ...
      console.log('Unexpected error, Try again later -_- ')
    }
